...
lbl_nome_usuario= tk.Label(janela,text="Qual é o seu nome ?",font=("Monocraft", 14),fg="#FFFFFF",bg="#000000")
lbl_nome_usuario.grid(row=1,column=0, padx=10,pady=10)
lbl_idade_usuario= tk.Label(janela,text="Quando você nasceu ?",font=("Monocraft", 14),fg="#FFFFFF",bg="#000000")
lbl_idade_usuario.grid(row=2,column=0,padx=10,pady=10)


ent_nome_usuario= tk.Entry(janela,font=("Monocraft", 14), width=30,fg="#FFFFFF",bg="#000000")
ent_nome_usuario.grid(row=1,column=1,padx=10,pady=10)
ent_idade_usuario= tk.Entry(janela,font=("Monocraft", 14),width=30, fg="#FFFFFF", bg="#000000")
ent_idade_usuario.grid(row=2,column=1,padx=10,pady=10)

btn_realizar_cadastro= tk.Button(janela,text="Calcular",font=("Monocraft", 14), fg="#000000",bg="#00FF7F",command=registre_usuario)
btn_realizar_cadastro.grid(row= 5, column=1, padx=10, pady=10)
btn_sair_janela= tk.Button(janela,text="Sair",font=("Monocraft", 14),fg="#000000",bg="#FF0000",command=janela.destroy)
